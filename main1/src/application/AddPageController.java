...
import GeneralBikeSubSystem.GeneralBikeManager;
public class AddPageController  implements Initializable{
	...
	public void createAddPagePane() throws IOException {
		Parent addPageParent = FXMLLoader.load(getClass().getResource("CreateBike.fxml"));
		AddPageController.addPagePane = new Scene(addPageParent);
	}
	
	
	//  event when click create button
	public void fireAddEvent(ActionEvent event) throws IOException, NumberFormatException, ParseException {
		...
		System.out.println(BikeInfo.get("Name"));
		System.out.println(BikeInfo.get("Weight"));
		System.out.println(BikeInfo.get("Manufactured Date"));
		System.out.println(BikeInfo.get("License Plate"));
		System.out.println(BikeInfo.get("Type"));
		System.out.println(BikeInfo.get("DockId"));
		System.out.println(BikeInfo.get("Battery Percent"));
		System.out.println(BikeInfo.get("Load Cycle"));
		System.out.println(BikeInfo.get("Estimate time left"));
